        ...
        <div class="modal-wrapper">
            <div class="modal-container" :style="{width: width + 'px'}">
                ...
                <div class="modal-footer">
                    <slot name="footer">
                        <button type="button" class="btn btn-primary" :class="{disabled: disabled}" @click.prevent="btnConfirm()">
                                <slot name="btnConfirm">Confirm</slot>
                            </button>
                        <button type="button" class="btn btn-default" @click.prevent="btnCancel()">
