<template>
    <modal :confirm="confirm" :disabled="disabled" identifier="create" width="500">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="btn-group" data-toggle="buttons">
                        <label @click="type = 'file'" class="btn btn-default btn-small" :class="{active: type === 'file'}">
                                <input value="file" type="radio" autocomplete="off">
                                File
                            </label>
                        <label @click="type = 'directory'" class="btn btn-default btn-small" :class="{active: type === 'directory'}">
        ...
        <template slot="btnConfirm">Create
</template>
    </modal>
</template>
